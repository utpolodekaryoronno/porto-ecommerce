                ...
                <div class="product-single-container product-single-default">
                    <div class="row">
                        <div class="col-lg-7 col-md-6 product-single-gallery">
                                ...
                                <div class="product-single-carousel owl-carousel owl-theme">
                                    @foreach ($product->gallery as $item)
                                        <div class="product-item">
                                            <img class="product-single-image" src="{{ asset('media/product/' . $item->file_name) }}" data-zoom-image="{{ asset('media/product/' . $item->file_name) }}"/>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="prod-thumbnail row owl-dots justify-content-center" id='carousel-custom-dots'>
                                    @foreach ($product->gallery as $item)
                                    <div class="col-3 owl-dot">
                                        <img src="{{ asset('media/product/' . $item->file_name) }}"/>
                                    </div>
                                    @endforeach
                            </div>
                        </div><!-- End .col-lg-7 -->
                        ...
                        <div class="col-lg-5 col-md-6">
                            <div class="product-single-details">
                                <h1 class="product-title">{{ $product->subtitle }}</h1>
            ...
            @foreach ($related_products as $item)
                ...
                <div class="product-default">
                    ...
                    <div class="product-details">
                        ...
                        <div class="price-box">
                            @if($item->sale_price)
                                <span class="product-price text-decoration-line-through" >$ {{$item->regular_price}}</span> &nbsp; &nbsp;
